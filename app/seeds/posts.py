...
def seed_posts():
    ...
    demo_post_1 = Post(
        user_id=1,
        community_id=None, # Community - Tech and Science
    ...
    demo_post_2 = Post(
        user_id=1,
        community_id=None, # Community - Learning and Education
    ...
    marnie_post_1 = Post(
        user_id=2,
        community_id=None, # Community - Love and Family
    ...
    bobbie_post_1 = Post(
        user_id=3,
        community_id=None, # Community - Animals and Pets
